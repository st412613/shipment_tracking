  ...
  return (
    <div className={classes.AboutCompanyContainer}>
      <div className={classes.AboutCompanyContent}>
        <p>The promoter of NOWTRANSIT CARGO PRIVATE LIMITED . is Miss. GAYATRI GOUD & Miss. SUMAN DEVI  who started this company on April 13th 2018 with an ambition of creating a highly motivated team to give personalized service to its clients</p>

        <p>The following are our Board of directors,</p> 
        <p>
        (a) Mrs. GAYATRI GOUD<br />
        (b) Mrs. SUMAN DEVI
        </p>
