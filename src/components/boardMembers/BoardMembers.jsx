      ...
      <Box sx={{ width: '90%', margin: 'auto' }}>
        <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
          <Grid item xs={12} sm={6}>
            <Item>
              <h4>Mr. Shiv Shankar Choudhary (CMD)</h4>
          ...
          <Grid item xs={12} sm={6}>
            <Item>
              <h4>Mrs. Trupti Choudhary (Executive Director)</h4>
              <p>She has good exp in Customer Support & Query solving. She is also manging administraton in MICS Logistics Pvt. Ltd.</p>
            </Item>
          </Grid>
        </Grid>
      </Box>
